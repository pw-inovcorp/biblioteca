<x-app-layout>
    ...
    <form method="POST" action="/autores" enctype="multipart/form-data">
        @csrf

        <div class="space-y-12 max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base font-semibold leading-7 text-gray-900">Criar um Novo Autor</h2>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href="/autores" type="button" class="text-sm font-semibold leading-6 text-gray-900">Cancelar</a>
